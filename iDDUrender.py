...
listLap = ['LapBestLapTime', 'LapLastLapTime', 'LapDeltaToSessionBestLap', 'dcFuelMixture', 'dcThrottleShape',
           ...
           'IsOnTrack', 'Gear', 'Speed', 'LapDistPct','DriverInfo', 'CarIdxLapDistPct', 'CarIdxOnPitRoad','SessionInfo']
...
init_data = {'LapBestLapTime': 0, 'LapLastLapTime': 0, 'LapDeltaToSessionBestLap': 0, 'dcFuelMixture': 0,
             ...
             'Speed': 0, 'DriverInfo': {'DriverCarIdx': 0, 'DriverCarFuelMaxLtr': 0, 'DriverCarMaxFuelPct': 1, 'Drivers': []}, 'CarIdxLapDistPct': [], 'CarIdxOnPitRoad': [],'SessionInfo': {'Sessions': [{'SessionType': 'Session', 'SessionTime': 'unlimited', 'SessionLaps': 0, 'ResultsPositions': [{'CarIdx': 0, 'JokerLapsComplete': 0}]}]}}
...
while not done:
    ...
    done = iRRender.render(iRData, calcData)
