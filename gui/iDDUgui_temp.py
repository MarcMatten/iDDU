...
class Ui_iDDU(object):
    def setupUi(self, iDDU):
        ...
        self.comboBox_NFuelConsumptionMethod.addItem("")
        self.comboBox_NFuelConsumptionMethod.addItem("")
        self.comboBox_NFuelConsumptionMethod.addItem("")
        self.comboBox_NFuelConsumptionMethod.addItem("")
        self.comboBox_NFuelConsumptionMethod.addItem("")
        ...
        self.comboBox_NFuelManagement.setMaxVisibleItems(3)
        ...
        self.comboBox_NFuelManagement.addItem("")
        self.comboBox_NFuelManagement.addItem("")
        self.comboBox_NFuelManagement.addItem("")
        self.comboBox_NFuelManagement.addItem("")
        self.comboBox_NFuelManagement.addItem("")
        ...
        self.testFuelTone.setGeometry(QtCore.QRect(310, 70, 141, 41))
    ...
    def retranslateUi(self, iDDU):
        ...
        self.comboBox_NFuelConsumptionMethod.setCurrentText(_translate("iDDU", "iRacing First RPM"))
        self.comboBox_NFuelConsumptionMethod.setItemText(0, _translate("iDDU", "iRacing First RPM"))
        self.comboBox_NFuelConsumptionMethod.setItemText(1, _translate("iDDU", "iRacing Shift RPM"))
        self.comboBox_NFuelConsumptionMethod.setItemText(2, _translate("iDDU", "iRacing Last RPM"))
        self.comboBox_NFuelConsumptionMethod.setItemText(3, _translate("iDDU", "iRacing Blink RPM"))
        self.comboBox_NFuelConsumptionMethod.setItemText(4, _translate("iDDU", "User defined"))
        self.comboBox_NFuelConsumptionMethod.setItemText(5, _translate("iDDU", "from Car properties"))
        self.label_NFuelConsumptionMethod.setText(_translate("iDDU", "Fuel Consumption Calculation Method"))
        self.comboBox_NFuelManagement.setItemText(0, _translate("iDDU", "iRacing First RPM"))
        self.comboBox_NFuelManagement.setItemText(1, _translate("iDDU", "iRacing Shift RPM"))
        self.comboBox_NFuelManagement.setItemText(2, _translate("iDDU", "iRacing Last RPM"))
        self.comboBox_NFuelManagement.setItemText(3, _translate("iDDU", "iRacing Blink RPM"))
        self.comboBox_NFuelManagement.setItemText(4, _translate("iDDU", "User defined"))
        self.comboBox_NFuelManagement.setItemText(5, _translate("iDDU", "from Car properties"))
        ...
        self.label_FuelToneDuration.setText(_translate("iDDU", "Lift Tone Duration"))
