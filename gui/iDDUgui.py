...
class Gui(object):
    ...
    def setupUi(self, Form, db):
        ...
        self.label_12 = QtWidgets.QLabel(self.tabGeneral)
        self.label_12.setGeometry(QtCore.QRect(40, 140, 101, 16))
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(self.tabGeneral)
        self.label_13.setGeometry(QtCore.QRect(40, 180, 101, 16))
        self.label_13.setObjectName("label_13")
        self.doubleSpinBox_JokerLapsRequired = QtWidgets.QDoubleSpinBox(self.tabGeneral)
        self.doubleSpinBox_JokerLapsRequired.setGeometry(QtCore.QRect(160, 180, 101, 22))
        ...
        self.label_14.setGeometry(QtCore.QRect(40, 220, 101, 16))
        self.label_14.setObjectName("label_14")
        self.doubleSpinBox_DRSActivations = QtWidgets.QDoubleSpinBox(self.tabGeneral)
        self.doubleSpinBox_DRSActivations.setGeometry(QtCore.QRect(160, 220, 101, 22))
        ...
        self.doubleSpinBox_JokerLapDelta = QtWidgets.QDoubleSpinBox(self.tabGeneral)
        self.doubleSpinBox_JokerLapDelta.setGeometry(QtCore.QRect(160, 140, 101, 22))
        self.doubleSpinBox_JokerLapDelta.setPrefix("")
        self.doubleSpinBox_JokerLapDelta.setSuffix("")
        self.doubleSpinBox_JokerLapDelta.setDecimals(1)
        ...
        self.label_15 = QtWidgets.QLabel(self.tabGeneral)
        self.label_15.setGeometry(QtCore.QRect(40, 260, 101, 16))
        self.label_15.setObjectName("label_15")
        self.doubleSpinBox_P2PActivations = QtWidgets.QDoubleSpinBox(self.tabGeneral)
        self.doubleSpinBox_P2PActivations.setGeometry(QtCore.QRect(160, 260, 101, 22))
        ...
        self.checkBox_MapHighlight = QtWidgets.QCheckBox(self.tabGeneral)
        self.checkBox_MapHighlight.setGeometry(QtCore.QRect(40, 300, 251, 17))
